...
leitor. O argumento de Eco converte"-se, como identificou Antoine Compagnon, numa maneira dissimulada de
...
É nesse sentido que, no prefácio à \emph{Estética}, de Hegel, Lukács lê os
...
Em ``Escrever a leitura'' (1970), Barthes expõe seus propósitos em \emph{S/Z},
...
Barthes lê \index{Jakobson, Roman}Jakobson, e com ele a \emph{nouvelle critique} e o grupo \emph{Tel quel},
...
Eliot, Drummond, Lispector ou Borges conferiram a seus textos. Essa
...
esse outro continue assinando ``Pamuk'', ``Eco'' ou ``Pessoa'' e se apresente com as
...
coisa que, a todo momento, como uma voz em surdina, \emph{se deixa trair} por ela. É dessa comunicação tácita que a literatura é
feita.
