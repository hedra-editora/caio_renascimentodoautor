...
episódio como ``ficcional'', simplesmente? Afinal, \index{Gógol, Nikolai}Gógol, como \index{Wael, Monique De}Monique
De Wael (\index{Wael, Monique De}Misha Defonseca), acreditava em sua mentira. E se uma dessas
...
\index{Éluard, Paul \also{Eugène Grindel}|gobbleone}
