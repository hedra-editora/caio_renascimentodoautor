...
\index{Pessoa, Fernando}Pessoa nos forneceu, em suma, contextos fictícios de produção para sua
...
Lourenço,\footnote{Eduardo Lourenço, \emph{Fernando Pessoa revisitado}
  ...
  Lisboa, Moraes Editores, 1981.} \index{Pessoa, Fernando}Pessoa não criou personalidades que
...
temática da infância em \index{Pessoa, Fernando}Pessoa, que tem forte retomada em todos os
...
à compartimentação da escrita em \index{Caeiro, Alberto}Caeiro, \index{Campos, Álvaro de}Campos, \index{Reis, Ricardo}Reis, \index{Pessoa, Fernando}Pessoa etc.
...
\index{Pessoa, Fernando}Pessoa (heteronimizado) funda o ortônimo.\footnote{Afirmando isso,
