...
vez apenas em 1954,\footnote{Marcel Proust, \emph{Contre Sainte"-Beuve}
  ...
  Ramanzini), São Paulo, Iluminuras, 1988.} \index{Proust, Marcel}Proust denuncia em tom
...
uma análise retrospectiva que \index{Man, Paul de}Paul de Man faz a respeito do \emph{new
criticism}. Para \index{Man, Paul de}de Man, os críticos formalistas americanos buscam, em
...
Em linhas gerais, \index{Man, Paul de}de Man figura entre os críticos mais empenhados em
...
aprofundamento dessa noção, tal como requerido por \index{Man, Paul de}de Man com relação a
...
Para autores como \index{Eco, Umberto}Eco, \index{Compagnon, Antoine}Compagnon e \index{Man, Paul de}de Man, termos como \emph{intentio
...
\index{Caeiro, Alberto}Caeiro do mesmo modo como nos reportamos a \index{Camões, Luís Vaz de}Camões ou a \index{Bocage, José Maria du}Bocage; isso porque, provavelmente, atribuir uma personalidade, e, portanto, uma
...
seu autor, mas \index{Caeiro, Alberto}Caeiro, \index{Campos, Álvaro de}Campos, \index{Reis, Ricardo}Reis, Soares\ldots{} e o ortônimo, ou seja, não o Fernando António Nogueira Pessoa, mas um Fernando Pessoa, homônimo
...
\index{Proust, Marcel}Proust, \index{Eliot, Thomas Stearns}Eliot e \index{Borges, Jorge Luis}Borges como escritores"-críticos, isto é, semeadores de
...
\index{Eliot, Thomas Stearns}Eliot, Wimsatt, \index{Barthes, Roland}Barthes, \index{Foucault, Michel}Foucault, \index{Eco, Umberto}Eco, \index{Derrida, Jacques}Derrida e \index{Man, Paul de}de Man.
...
\begin{flushright}
{\small
\parbox{175pt}{\emph{Não sou eu quem descrevo. Eu sou a tela}.}

\parbox{75pt}{Fernando Pessoa}
}
\end{flushright}
...
de Fernando Pessoa \index{Caeiro, Alberto}Alberto Caeiro a Fernando Pessoa ele só. Ou melhor,
...
escritor \index{Côrtes-Rodrigues, Armando}Armando Côrtes"-Rodrigues, de 4 de outubro de 1914 -- escrita,
...
\item
  \begin{quote}
  Poesias e prosas de \index{Côrtes-Rodrigues, Armando}A. Côrtes"-Rodrigues. (Vá v. vendo o que de mais
...
heteronímico, alterações nos perfis que Pessoa traça a \index{Caeiro, Alberto}Caeiro e \index{Campos, Álvaro de}Campos.
...
por \index{Caeiro, Alberto}Caeiro. Daí Pessoa ter explicado, antropologicamente, tratar"-se de
...
dicção de \index{Reis, Ricardo}Reis, transparecendo num poema assinado como ``Fernando
...
seus. O primeiro biógrafo de Pessoa, \index{Simões, João Gaspar}João Gaspar Simões, entende ser
essa a voz \emph{real} e \emph{sincera} de Pessoa. Autores vários, como
\index{Bréchon, Robert}Robert Bréchon e \index{Lopes, Óscar}Óscar Lopes, identificaram a recorrência dessa voz na
...
à compartimentação da escrita em \index{Caeiro, Alberto}Caeiro, \index{Campos, Álvaro de}Campos, \index{Reis, Ricardo}Reis, Pessoa etc.
...
Oblíqua'', o que de fato Pessoa produz é (para dizer como \index{Sena, Jorge de}Jorge de Sena
já o fizera há mais de meio século) um outro heterônimo mascarado de
ortônimo. \index{Sena, Jorge de}Sena dizia a Pessoa, postumamente, e entre parênteses: ``(e
...
na leitura crítica de \index{Sena, Jorge de}Sena sobre Pessoa, posteriormente desenvolvida em
...
poemas assinados como ``Fernando Pessoa''. Em ``\index{Reis, Ricardo}Reis'' ela também se
repete:
...
\index{Caeiro, Alberto}Caeiro foi designado por Pessoa como \emph{mestre}, a instância autoral
...
acaso, com exceção concedida a ``\index{Reis, Ricardo}Reis'', Pessoa cogitará atribuir a
...
Pessoa (heteronimizado) funda o ortônimo.\footnote{Afirmando isso,
  ...
  interno de Fernando Pessoa o whitmaniano \index{Campos, Álvaro de}Álvaro de Campos, ele
...
Vega e \index{la Barca, Calderón de}Calderón de la Barca é simultâneo ao de um novo gênero, misto e,
...
\index{Frey, James}Frey, \index{Wilkomirski, Binjamin}Wilkomirski e Holstein, uma vez desvendadas as farsas biográficas
...
Quando lemos ``O nariz'', de \index{Gógol, Nikolai}Gógol, estando cientes de que o autor o
...
episódio como ``ficcional'', simplesmente? Afinal, \index{Gógol, Nikolai}Gógol, como Monique
...
esse outro continue assinando ``\index{Pamuk, Orhan}Pamuk'', \index{Eco, Umberto}``Eco'' ou ``Pessoa'' e se apresente com as mesmas feições dos sujeitos empíricos que pagam suas contas e atendem ao
