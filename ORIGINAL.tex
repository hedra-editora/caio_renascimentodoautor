...
\hedramarkboth{Autoria e heteronímia na moderna teoria da literatura}{}
...
Em ``A nova poesia russa'' (1919), Jakobson define
...
Em~\emph{Contre Sainte-Beuve}, escrito em 1900 e publicado pela primeira
...
Em outra séria contestação do método crítico de Sainte-Beuve, T. S.
...
poeta (...), os que se referem exclusivamente à sua vida pública (...),
e também tudo aquilo que concerne aos seus estudos de botânica,
anatomia, filosofia ou história (...). O crítico e historiador deve
...
uma entidade quantificável. (...) A morte do autor, proclamada por
...
Dessa aproximação entre autor e leitor, Umberto Eco se vale com especial
...
Esses postulados são estranhos à crítica anti-intencionalista. O texto,
considerado como um código autônomo com relação ao autor, há muito
deixou de ser considerado um porto seguro para o leitor. Para muitos
...
\addcontentsline{toc}{section}{III. Escrever é heteronimizar
\medskip}
...
seu autor, mas Caeiro, Campos, Reis, Soares... e o ortônimo, ou seja,
...
\chapter*{Depõe-se um rei, a paternidade do poema: ``Chuva Oblíqua'' e a forma heteronímica em Fernando Pessoa}
...
de mão em mão: e, estranhamente, as primeiras em que esteve, foram... as
...
uma ``reação (...) contra sua inexistência''. Para Pessoa, o autor de
...
alma...''.\footnote{Ibidem, p. 66.} E Reis: ``Meus dias, mas que um
...
eu citava o que eles dizem...). Mas sei eu ao certo o que isso, mesmo
...
Com o som de rodas de automóvel...''; (\textsc{iii}) ``E sobre o papel
...
primavera lá fora / Sobre o eu estar de olhos fechados...'';
...
não pensam em voltar...''; (\textsc{vi}) ``E do alto dum cavalo azul, o
...
abaixo...''. As coisas, em suma, vestem-se de outras, perdem suas linhas
de demarcação.
...
como numa peneira''. No poema III, o eu lírico escreve, não no presente,
tampouco no passado, mas num presente do passado: ``De repente paro... /
Escureceu tudo... Caio por um abismo feito de tempo... / Estou soterrado
sob as pirâmides a escrever versos à luz clara deste candeeiro / E todo
o Egito me esmaga de alto através dos traços que faço com a pena...''
...
interior: ``Liberto em duplo, abandonei-me da paisagem abaixo...'',
...
minha alma...''. É como se a bipolaridade constituinte do poema,
...
papel dentro...''. Isso significa que a imagem que tomamos como evocada
...
(...)''. Aqui, é efetivamente a linguagem que fala, não seu autor. Essa
...
\addcontentsline{toc}{section}{III. Eu sou a tela
\medskip}
...
Soam-me a um outro e anómalo sentido...\footnote{Poema \textsc{xiii}.
  Ibid., p. 397.}

Na verdade, o que acontecerá a partir de então é que Pessoa sofrerá as
...
Com que alguém escreve a valer o que nós aqui traçamos?\footnote{\emph{Poesia
...
\begin{quote}
(...) ou seja, é sobre o que se interpõe e medeia a superfície da
...
Pessoa (heteronimizado) funda o ortônimo.\footnote{Afirmando isso,
  ...
  Bernardo Soares. (...) Naquele período, o que ocupava Pessoa era o
...
anteriormente,\footnote{``A atestá-lo está toda a poesia de Fernando
  ...
  (...), nem centração da paisagem no espaço interior, nem oposições
...
\chapter*{Autor, autoria e autoridade: Argumentação e ideologia em Roland Barthes}
...
espaço textual. Dizer algo do gênero ``Balzac quis dizer que...'' é uma
...
Explicar um texto segundo seu autor implica conceber a intenção como uma
...
\begin{quote}
(...) não possui mais em si paixões, humores, sentimentos, impressões,
...
jogo de compensações: ``(...) o autor entra na sua própria morte, a
...
Em ``Escrever a leitura'' (1970), Barthes expõe seus propósitos em S/Z,
...
\begin{quote}
Além de qualquer intenção específica que a poesia possa ter (...) há
...
\addcontentsline{toc}{section}{VI. Autoria e autoridade: fora os rinocerontes!
\medskip}
...
Pasolini, aliás, percebeu, tão logo começou a se agravar, o processo de
...
fora do poder''.\footnote{Roland Barthes, \emph{Aula} (tradução de Leyla
  Perrone-Moisés), 7\textsuperscript{ª} ed, São Paulo, Cultrix, 1997, p.
...
\begin{quote}
(...) evidenciou-se que, à medida que os aparelhos de contestação se
...
\chapter*{Disfarce e fraude autoral: Memória, testemunho e ficção}
...
diferenciar a realidade do meu mundo interior''.\footnote{``The book is
  a story, it's my story (...) It's not the true reality, but it is my
...
e decidiu revelar a verdade ao jornal.\footnote{Para uma resenha
  ...
  \textless{}http://www.nytimes.com/2008/02/26/books/26kaku.html?pagewanted=all\&\_r=0\textgreater{},
  ...
  \textless{}http://www.nytimes.com/2008/03/04/books/04fake.html?pagewanted=all\textgreater{},
...
minorias, discriminadas pela sociedade.\footnote{Outro artigo consultado
  ...
  2008{]}, disponível em \textless{}\emph{http://usatoday30.usatoday.com/life/books/news/2008-03-04-memoir-hoax\_N.htm}\textgreater{}, acesso em 22 nov. 2017.}
...
ficction''.\footnote{Cf. Meghan O´Rourke, ``Lies and Consequences: Why
  ...
  disponível em:
  \textless{}http://www.slate.com/articles/news\_and\_politics/recycled/2008/03/lies\_and\_consequences.html\textgreater{},
...
do previsto no original. Quando Cervantes escreve: ``... a verdade, cuja
...
\addcontentsline{toc}{section}{V. Para além do risco romântico
\bigskip}
...
\emph{desegotização} da poesia moderna.\footnote{Apud Dominique Combe,
  ...
  Lyrique} (organização de Dominique Rabaté), Paris, PUF,1996, p. 136.}
...
descentramento constitutivo do escritor: ``(...) dediquei todas as
...
\emph{Revista USP}, n. 84, dez.-fev. 2009, 2010.
...
crítica de Maria Aliete Galhoz. Lisboa: INCM, 2008.
...
\begin{quote}
Disponível em: \textless{}http://archive.is/iHRk6\textgreater{}. Acesso
em: 22 nov. 2017.
\end{quote}
...
\begin{quote}
Disponível em:
\textless{}http://usatoday30.usatoday.com/life/books/news/2008-03-04-memoir-hoax\_N.htm\textgreater{}.
Acesso em: 22 nov. 2017.
\end{quote}
